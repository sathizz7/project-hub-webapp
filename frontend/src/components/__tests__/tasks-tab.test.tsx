...
const tasks: SerializedTask[] = [
  { id: "t1", title: "Implement Redis throttling", priority: "high", status: "in_progress", dueDate: "2026-05-10T00:00:00.000Z", assignee: { id: "u1", name: "Priya" } },
  { id: "t2", title: "Write unit tests", priority: "medium", status: "completed", dueDate: null, assignee: null },
];
